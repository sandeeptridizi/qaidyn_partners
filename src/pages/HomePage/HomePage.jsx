...
const HomePage = () => {
  ...
  const [heroData, setHeroData] = useState({
    title:
      'Smart, Secure & Reliable Technology Solutions for Today’s Digital World',
    description:
      ...
      >
        <div className='container-full'>
          <div className='cs-services-header'>
            ...
            <p className='cs-sub'>
              End-to-end technology services designed to secure your systems and
          ...
          <div className='service-modal' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='modal-header'>
              ...
              <h3
                ...
                onClick={() => {
                  const route = navigateMap[services[activeServiceModal].title];
          ...
          <div className='industries-header'>
            ...
            <div className='industries-text'>
              ...
              <p className='industries-subtitle'>
                Empowering multiple industries with reliable, secure, and
            ...
            <div className='process-steps'>
              ...
              <div className='process-step'>
                ...
                <div className='step-content'>
                  ...
                  <p className='step-description'>
                    We provide continuous monitoring, proactive issue
                    resolution, and dedicated support to ensure everything runs
                    smoothly.
                  </p>
                </div>
              </div>
        ...
        <div className='cta-content'>
          <div className='cta-text'>
            <h2 className='cta-title'>
              Let’s Build a Smarter, Secure IT Future Together
            </h2>
