      ...
      <main className='power-container'>
        <div className='power-content-container'>
          <h1 className='power-heading'>
            Zero Upfront Costs. Infinite Performance. Welcome to
            IT-as-a-Service.
          </h1>
          <p className='power-text'>
            Why sink your startup capital into hardware that depreciates? With
            our novel Managed Infrastructure Plan, we remove the financial
            barrier to entry. We provide the equipment, the setup, and the
            support—all bundled into one predictable monthly fee. No massive
            invoices, no maintenance headaches, no obsolete tech.
          </p>
          <div className='power-grid-container'>
            <h3 className='power-item-heading'>How It Works</h3>
            <div className='power-item-container'>
              <img
                src='https://images.unsplash.com/photo-1681383064412-171e5bee5f6e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
              <div className='power-item-content-container'>
                <h3 className='step-heading'>Step 1</h3>
                <p className='power-item-title'>Hardware Included: </p>
                <p className='power-item-text'>
                  We supply the latest managed routers, switches, servers, and
                  workstations with $0 upfront cost.
                </p>
              </div>
            </div>
            <div className='power-item-container'>
              <div className='power-item-content-container'>
                ...
                <p className='power-item-title'>Always Current: </p>
                <p className='power-item-text'>
                  Because the hardware is part of your service, we manage the
                  lifecycle. When it’s time for an upgrade, we handle it. Your
                  business stays "evergreen."
                </p>
              </div>
              <img
                src='https://plus.unsplash.com/premium_photo-1683121716061-3faddf4dc504?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
            </div>
            <div className='power-item-container'>
              ...
              <div className='power-item-content-container'>
                ...
                <p className='power-item-title'>Predictable Cash Flow: </p>
                <p className='power-item-text'>
                  Shift your IT from a volatile Capital Expense (CapEx) to a
                  steady, tax-friendly Operating Expense (OpEx).
                </p>
              </div>
            </div>
            <div className='power-item-container'>
              <div className='power-item-content-container'>
                ...
                <p className='power-item-text'>
                  New Dental or General Practices wanting to preserve cash for
                  operations. Growing businesses that want to scale their tech
                  without massive debt.
                </p>
              </div>
              <img
                src='https://plus.unsplash.com/premium_photo-1661497292411-8e1ed69525b5?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
            </div>
...
export default EvergreenInfrastructure;
