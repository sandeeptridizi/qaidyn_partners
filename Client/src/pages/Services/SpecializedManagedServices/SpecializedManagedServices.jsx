...
const SpecializedManagedServices = () => {
      ...
      <main className='power-container'>
        <div className='power-content-container'>
          <h1 className='power-heading'>
            Beyond the Hardware: Your 24/7 Security & Support Team.
          </h1>
          <div className='power-grid-container'>
            <h3 className='power-item-heading'>The Core Services</h3>
            <div className='power-item-container'>
              <img
                src='https://plus.unsplash.com/premium_photo-1700830452756-1a3f4314e564?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
              <div className='power-item-content-container'>
                <h3 className='step-heading'>Step 1</h3>
                <p className='power-item-title'>
                  Cyber Security Provisioning:{' '}
                </p>
                <p className='power-item-text'>
                  We protect your patient data and devices with enterprise-grade
                  threat detection. In a world of increasing breaches, we act as
                  your digital shield.
                </p>
              </div>
            </div>
            <div className='power-item-container'>
              <div className='power-item-content-container'>
                ...
                <p className='power-item-title'>Onsite & Offsite Backup: </p>
                <p className='power-item-text'>
                  Never lose a file. We provision redundant backup solutions
                  that ensure your data is recoverable in minutes, not days.
                </p>
              </div>
              <img
                src='https://images.unsplash.com/photo-1624895608078-e9f564cbe3fa?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
            </div>
            <div className='power-item-container'>
              <img
                src='https://plus.unsplash.com/premium_photo-1727154572044-81c9829dc2e8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
              <div className='power-item-content-container'>
                <h3 className='step-heading'>Step 3</h3>
                <p className='power-item-title'>VoIP & Communication: </p>
                <p className='power-item-text'>
                  Seamlessly integrated voice systems designed for the
                  high-volume environment of a busy clinic.
                </p>
              </div>
            </div>
            <div className='power-item-container'>
              <div className='power-item-content-container'>
                ...
                <p className='power-item-title'>Continuous Monitoring: </p>
                <p className='power-item-text'>
                  We detect and resolve issues in your network, cloud, and
                  devices in real-time—often before you even know there’s a
                  problem.
                </p>
              </div>
              <img
                src='https://plus.unsplash.com/premium_photo-1683288706548-e8b6bb72fe86?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                alt='servers'
                className='server-img'
              />
            </div>
...
export default SpecializedManagedServices;
